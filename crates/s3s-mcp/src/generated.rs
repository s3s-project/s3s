...
pub fn tool_definitions() -> Vec<Tool> {
    ...
    vec![
        ...
        Tool::new(
            "copy_object",
            "Creates a copy of an object that is already stored in Amazon S3. You can store individual objects of up to 5 TB in Amazon S3. You create a copy of your object up to 5 GB in size in a single atomic ...",
            Arc::clone(&schema),
        ),
        Tool::new(
            "create_bucket",
        ...
        Tool::new(
            ...
            "Creates a metadata table configuration for a general purpose bucket. For more information, see Accelerating data discovery with S3 Metadata in the Amazon S3 User Guide. Permissions To use this oper...",
            Arc::clone(&schema),
        ),
        Tool::new(
            "create_multipart_upload",
            "This action initiates a multipart upload and returns an upload ID. This upload ID is used to associate all of the parts in the specific multipart upload. You specify this upload ID in each of your ...",
            Arc::clone(&schema),
        ),
        Tool::new(
            "delete_bucket",
        ...
        Tool::new(
            ...
            "This operation is not supported for directory buckets. Deletes an inventory configuration (identified by the inventory ID) from the bucket. To use this operation, you must have permissions to perfo...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            ...
            "Deletes a metadata table configuration from a general purpose bucket. For more information, see Accelerating data discovery with S3 Metadata in the Amazon S3 User Guide. Permissions To use this ope...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            ...
            "This operation is not supported for directory buckets. Deletes the tags from the bucket. To use this operation, you must have permission to perform the s3:PutBucketTagging action. By default, the b...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            ...
            "This operation is not supported for directory buckets. Removes the PublicAccessBlock configuration for an Amazon S3 bucket. To use this operation, you must have the s3:PutBucketPublicAccessBlock pe...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            ...
            "This operation is not supported for directory buckets. Returns an inventory configuration (identified by the inventory configuration ID) from the bucket. To use this operation, you must have permis...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            "get_bucket_location",
            "This operation is not supported for directory buckets. Returns the Region the bucket resides in. You set the bucket's Region using the LocationConstraint request parameter in a CreateBucket request...",
            Arc::clone(&schema),
        ),
        Tool::new(
            "get_bucket_logging",
        ...
        Tool::new(
            ...
            "Retrieves the metadata table configuration for a general purpose bucket. For more information, see Accelerating data discovery with S3 Metadata in the Amazon S3 User Guide. Permissions To use this ...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            "get_bucket_tagging",
            "This operation is not supported for directory buckets. Returns the tag set associated with the bucket. To use this operation, you must have permission to perform the s3:GetBucketTagging action. By ...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            ...
            "Retrieves all the metadata from an object without returning the object itself. This operation is useful if you're interested only in an object's metadata. GetObjectAttributes combines the functiona...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            ...
            "This operation is not supported for directory buckets. Retrieves the PublicAccessBlock configuration for an Amazon S3 bucket. To use this operation, you must have the s3:GetBucketPublicAccessBlock ...",
            Arc::clone(&schema),
        ),
        Tool::new(
            "head_bucket",
            "You can use this operation to determine if a bucket exists and if you have permission to access it. The action returns a 200 OK if the bucket exists and you have permission to access it. If the buc...",
            Arc::clone(&schema),
        ),
        Tool::new(
            "head_object",
        ...
        Tool::new(
            ...
            "This operation is not supported for directory buckets. Returns a list of inventory configurations for the bucket. You can have up to 1,000 analytics configurations per bucket. This action supports ...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            "put_bucket_acl",
            "This operation is not supported for directory buckets. Sets the permissions on an existing bucket using access control lists (ACL). For more information, see Using ACLs. To set the ACL of a bucket,...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            ...
            "This operation configures default encryption and Amazon S3 Bucket Keys for an existing bucket. Directory buckets - For directory buckets, you must make requests for this API operation to the Region...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            ...
            "This operation is not supported for directory buckets. This implementation of the PUT action adds an inventory configuration (identified by the inventory ID) to the bucket. You can have up to 1,000...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            "put_bucket_logging",
            "This operation is not supported for directory buckets. Set the logging parameters for a bucket and to specify permissions for who can view and modify the logging parameters. All logs are saved to b...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            "put_bucket_tagging",
            "This operation is not supported for directory buckets. Sets the tags for a bucket. Use tags to organize your Amazon Web Services bill to reflect your own cost structure. To do this, sign up to get ...",
            Arc::clone(&schema),
        ),
        Tool::new(
        ...
        Tool::new(
            "put_object",
            "Adds an object to a bucket. Amazon S3 never adds partial objects; if you receive a success response, Amazon S3 added the entire object to the bucket. You cannot use PutObject to only update a singl...",
            Arc::clone(&schema),
        ),
        Tool::new(
            "put_object_acl",
            "This operation is not supported for directory buckets. Uses the acl subresource to set the access control list (ACL) permissions for a new or existing object in an S3 bucket. You must have the WRIT...",
            Arc::clone(&schema),
        ),
        Tool::new(
...
pub async fn dispatch(s3: &dyn S3, name: &str) -> Result<CallToolResult, rmcp::ErrorData> {
    match name {
        ...
        "copy_object" => Ok(CallToolResult::error(vec![Content::text(
            "CopyObject requires parameters that are not yet supported".to_string(),
        )])),
        "create_bucket" => {
        ...
        "create_bucket_metadata_table_configuration" => Ok(CallToolResult::error(vec![Content::text(
            "CreateBucketMetadataTableConfiguration requires parameters that are not yet supported".to_string(),
        )])),
        "create_multipart_upload" => {
        ...
        "delete_objects" => Ok(CallToolResult::error(vec![Content::text(
            "DeleteObjects requires parameters that are not yet supported".to_string(),
        )])),
        "delete_public_access_block" => {
        ...
        "put_bucket_accelerate_configuration" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketAccelerateConfiguration requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_acl" => {
        ...
        "put_bucket_analytics_configuration" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketAnalyticsConfiguration requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_cors" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketCors requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_encryption" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketEncryption requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_intelligent_tiering_configuration" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketIntelligentTieringConfiguration requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_inventory_configuration" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketInventoryConfiguration requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_lifecycle_configuration" => {
        ...
        "put_bucket_logging" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketLogging requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_metrics_configuration" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketMetricsConfiguration requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_notification_configuration" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketNotificationConfiguration requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_ownership_controls" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketOwnershipControls requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_policy" => {
        ...
        "put_bucket_replication" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketReplication requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_request_payment" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketRequestPayment requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_tagging" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketTagging requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_versioning" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketVersioning requires parameters that are not yet supported".to_string(),
        )])),
        "put_bucket_website" => Ok(CallToolResult::error(vec![Content::text(
            "PutBucketWebsite requires parameters that are not yet supported".to_string(),
        )])),
        "put_object" => {
        ...
        "put_object_tagging" => Ok(CallToolResult::error(vec![Content::text(
            "PutObjectTagging requires parameters that are not yet supported".to_string(),
        )])),
        "put_public_access_block" => Ok(CallToolResult::error(vec![Content::text(
            "PutPublicAccessBlock requires parameters that are not yet supported".to_string(),
        )])),
        "restore_object" => {
        ...
        "select_object_content" => Ok(CallToolResult::error(vec![Content::text(
            "SelectObjectContent requires parameters that are not yet supported".to_string(),
        )])),
        "upload_part" => {
        ...
        "upload_part_copy" => Ok(CallToolResult::error(vec![Content::text(
            "UploadPartCopy requires parameters that are not yet supported".to_string(),
        )])),
        "write_get_object_response" => {
