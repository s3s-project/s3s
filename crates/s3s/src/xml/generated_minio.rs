...
if days_after_initiation.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Status" => {
if status.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"AccessControlList" => {
if grants.is_some() { return Err(DeError::DuplicateField); }
grants = Some(d.list_content("Grant")?);
Ok(())
}
b"Owner" => {
if owner.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Prefix" => {
if prefix.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Filter" => {
if filter.is_some() { return Err(DeError::DuplicateField); }
filter = Some(d.content()?);
Ok(())
}
b"Id" => {
if id.is_some() { return Err(DeError::DuplicateField); }
id = Some(d.content()?);
Ok(())
}
b"StorageClassAnalysis" => {
if storage_class_analysis.is_some() { return Err(DeError::DuplicateField); }
...
if s3_bucket_destination.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Bucket" => {
if bucket.is_some() { return Err(DeError::DuplicateField); }
bucket = Some(d.content()?);
Ok(())
}
b"BucketAccountId" => {
if bucket_account_id.is_some() { return Err(DeError::DuplicateField); }
bucket_account_id = Some(d.content()?);
Ok(())
}
b"Format" => {
if format.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"AssumedRoleUser" => {
if assumed_role_user.is_some() { return Err(DeError::DuplicateField); }
assumed_role_user = Some(d.content()?);
Ok(())
}
b"Credentials" => {
if credentials.is_some() { return Err(DeError::DuplicateField); }
credentials = Some(d.content()?);
Ok(())
}
b"PackedPolicySize" => {
if packed_policy_size.is_some() { return Err(DeError::DuplicateField); }
packed_policy_size = Some(d.content()?);
Ok(())
}
b"SourceIdentity" => {
if source_identity.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Arn" => {
if arn.is_some() { return Err(DeError::DuplicateField); }
arn = Some(d.content()?);
Ok(())
}
b"AssumedRoleId" => {
if assumed_role_id.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"BucketRegion" => {
if bucket_region.is_some() { return Err(DeError::DuplicateField); }
bucket_region = Some(d.content()?);
Ok(())
}
b"CreationDate" => {
if creation_date.is_some() { return Err(DeError::DuplicateField); }
creation_date = Some(d.timestamp(TimestampFormat::DateTime)?);
Ok(())
}
b"Name" => {
if name.is_some() { return Err(DeError::DuplicateField); }
name = Some(d.content()?);
Ok(())
}
_ => Err(DeError::UnexpectedTagName)
...
d.for_each_element(|d, x| match x {
b"DataRedundancy" => {
if data_redundancy.is_some() { return Err(DeError::DuplicateField); }
data_redundancy = Some(d.content()?);
Ok(())
}
b"Type" => {
if type_.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"ExpiryUpdatedAt" => {
if expiry_updated_at.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"LoggingEnabled" => {
if logging_enabled.is_some() { return Err(DeError::DuplicateField); }
...
b"MaxAgeSeconds" => {
if max_age_seconds.is_some() { return Err(DeError::DuplicateField); }
...
if allow_quoted_record_delimiter.is_some() { return Err(DeError::DuplicateField); }
allow_quoted_record_delimiter = Some(d.content()?);
Ok(())
}
b"Comments" => {
if comments.is_some() { return Err(DeError::DuplicateField); }
comments = Some(d.content()?);
Ok(())
}
b"FieldDelimiter" => {
if field_delimiter.is_some() { return Err(DeError::DuplicateField); }
field_delimiter = Some(d.content()?);
Ok(())
}
b"FileHeaderInfo" => {
if file_header_info.is_some() { return Err(DeError::DuplicateField); }
file_header_info = Some(d.content()?);
Ok(())
}
b"QuoteCharacter" => {
if quote_character.is_some() { return Err(DeError::DuplicateField); }
quote_character = Some(d.content()?);
Ok(())
}
b"QuoteEscapeCharacter" => {
if quote_escape_character.is_some() { return Err(DeError::DuplicateField); }
quote_escape_character = Some(d.content()?);
Ok(())
}
b"RecordDelimiter" => {
if record_delimiter.is_some() { return Err(DeError::DuplicateField); }
...
b"QuoteFields" => {
if quote_fields.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"ChecksumCRC32" => {
if checksum_crc32.is_some() { return Err(DeError::DuplicateField); }
checksum_crc32 = Some(d.content()?);
Ok(())
}
b"ChecksumCRC32C" => {
if checksum_crc32c.is_some() { return Err(DeError::DuplicateField); }
checksum_crc32c = Some(d.content()?);
Ok(())
}
b"ChecksumCRC64NVME" => {
if checksum_crc64nvme.is_some() { return Err(DeError::DuplicateField); }
checksum_crc64nvme = Some(d.content()?);
Ok(())
}
b"ChecksumSHA1" => {
if checksum_sha1.is_some() { return Err(DeError::DuplicateField); }
checksum_sha1 = Some(d.content()?);
Ok(())
}
b"ChecksumSHA256" => {
if checksum_sha256.is_some() { return Err(DeError::DuplicateField); }
checksum_sha256 = Some(d.content()?);
Ok(())
}
b"ChecksumType" => {
if checksum_type.is_some() { return Err(DeError::DuplicateField); }
...
b"ETag" => {
if e_tag.is_some() { return Err(DeError::DuplicateField); }
e_tag = Some(d.content()?);
Ok(())
}
b"PartNumber" => {
if part_number.is_some() { return Err(DeError::DuplicateField); }
...
if http_error_code_returned_equals.is_some() { return Err(DeError::DuplicateField); }
http_error_code_returned_equals = Some(d.content()?);
Ok(())
}
b"KeyPrefixEquals" => {
if key_prefix_equals.is_some() { return Err(DeError::DuplicateField); }
...
b"LastModified" => {
if last_modified.is_some() { return Err(DeError::DuplicateField); }
...
b"Location" => {
if location.is_some() { return Err(DeError::DuplicateField); }
location = Some(d.content()?);
Ok(())
}
b"LocationConstraint" => {
if location_constraint.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"AccessKeyId" => {
if access_key_id.is_some() { return Err(DeError::DuplicateField); }
access_key_id = Some(d.content()?);
Ok(())
}
b"Expiration" => {
if expiration.is_some() { return Err(DeError::DuplicateField); }
expiration = Some(d.timestamp(TimestampFormat::DateTime)?);
Ok(())
}
b"SecretAccessKey" => {
if secret_access_key.is_some() { return Err(DeError::DuplicateField); }
secret_access_key = Some(d.content()?);
Ok(())
}
b"SessionToken" => {
if session_token.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Days" => {
if days.is_some() { return Err(DeError::DuplicateField); }
days = Some(d.content()?);
Ok(())
}
b"Mode" => {
if mode.is_some() { return Err(DeError::DuplicateField); }
mode = Some(d.content()?);
Ok(())
}
b"Years" => {
if years.is_some() { return Err(DeError::DuplicateField); }
...
b"Quiet" => {
if quiet.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"IsLatest" => {
if is_latest.is_some() { return Err(DeError::DuplicateField); }
is_latest = Some(d.content()?);
Ok(())
}
b"Key" => {
if key.is_some() { return Err(DeError::DuplicateField); }
key = Some(d.content()?);
Ok(())
}
b"LastModified" => {
...
b"VersionId" => {
if version_id.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"DeleteMarker" => {
if delete_marker.is_some() { return Err(DeError::DuplicateField); }
delete_marker = Some(d.content()?);
Ok(())
}
b"DeleteMarkerVersionId" => {
if delete_marker_version_id.is_some() { return Err(DeError::DuplicateField); }
...
if access_control_translation.is_some() { return Err(DeError::DuplicateField); }
access_control_translation = Some(d.content()?);
Ok(())
}
b"Account" => {
if account.is_some() { return Err(DeError::DuplicateField); }
...
if encryption_configuration.is_some() { return Err(DeError::DuplicateField); }
encryption_configuration = Some(d.content()?);
Ok(())
}
b"Metrics" => {
if metrics.is_some() { return Err(DeError::DuplicateField); }
metrics = Some(d.content()?);
Ok(())
}
b"ReplicationTime" => {
if replication_time.is_some() { return Err(DeError::DuplicateField); }
replication_time = Some(d.content()?);
Ok(())
}
b"StorageClass" => {
if storage_class.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"EncryptionType" => {
if encryption_type.is_some() { return Err(DeError::DuplicateField); }
encryption_type = Some(d.content()?);
Ok(())
}
b"KMSContext" => {
if kms_context.is_some() { return Err(DeError::DuplicateField); }
kms_context = Some(d.content()?);
Ok(())
}
b"KMSKeyId" => {
if kms_key_id.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"ReplicaKmsKeyID" => {
if replica_kms_key_id.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Code" => {
if code.is_some() { return Err(DeError::DuplicateField); }
code = Some(d.content()?);
Ok(())
}
b"Key" => {
...
b"Message" => {
if message.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"ErrorCode" => {
if error_code.is_some() { return Err(DeError::DuplicateField); }
error_code = Some(d.content()?);
Ok(())
}
b"ErrorMessage" => {
if error_message.is_some() { return Err(DeError::DuplicateField); }
...
b"Value" => {
if value.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Error" => {
if error.is_some() { return Err(DeError::DuplicateField); }
error = Some(d.content()?);
Ok(())
}
b"MetadataTableConfigurationResult" => {
if metadata_table_configuration_result.is_some() { return Err(DeError::DuplicateField); }
...
if event_bridge_configuration.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Payer" => {
if payer.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"TagSet" => {
if tag_set.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"MfaDelete" => {
if mfa_delete.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"ErrorDocument" => {
if error_document.is_some() { return Err(DeError::DuplicateField); }
error_document = Some(d.content()?);
Ok(())
}
b"IndexDocument" => {
if index_document.is_some() { return Err(DeError::DuplicateField); }
index_document = Some(d.content()?);
Ok(())
}
b"RedirectAllRequestsTo" => {
if redirect_all_requests_to.is_some() { return Err(DeError::DuplicateField); }
redirect_all_requests_to = Some(d.content()?);
Ok(())
}
b"RoutingRules" => {
if routing_rules.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"IsTruncated" => {
if is_truncated.is_some() { return Err(DeError::DuplicateField); }
is_truncated = Some(d.content()?);
Ok(())
}
b"MaxParts" => {
if max_parts.is_some() { return Err(DeError::DuplicateField); }
max_parts = Some(d.content()?);
Ok(())
}
b"NextPartNumberMarker" => {
if next_part_number_marker.is_some() { return Err(DeError::DuplicateField); }
next_part_number_marker = Some(d.content()?);
Ok(())
}
b"PartNumberMarker" => {
if part_number_marker.is_some() { return Err(DeError::DuplicateField); }
...
b"PartsCount" => {
if total_parts_count.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Tier" => {
if tier.is_some() { return Err(DeError::DuplicateField); }
tier = Some(d.content()?);
Ok(())
}
_ => Err(DeError::UnexpectedTagName)
...
b"Grantee" => {
if grantee.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"DisplayName" => {
    if display_name.is_some() { return Err(DeError::DuplicateField); }
        display_name = Some(d.content()?);
    Ok(())
}
b"EmailAddress" => {
    if email_address.is_some() { return Err(DeError::DuplicateField); }
...
b"URI" => {
    if uri.is_some() { return Err(DeError::DuplicateField); }
        uri = Some(d.content()?);
    Ok(())
}
_ => Err(DeError::UnexpectedTagName),
...
b"Permission" => {
if permission.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Suffix" => {
if suffix.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"CSV" => {
if csv.is_some() { return Err(DeError::DuplicateField); }
csv = Some(d.content()?);
Ok(())
}
b"CompressionType" => {
if compression_type.is_some() { return Err(DeError::DuplicateField); }
compression_type = Some(d.content()?);
Ok(())
}
b"JSON" => {
if json.is_some() { return Err(DeError::DuplicateField); }
json = Some(d.content()?);
Ok(())
}
b"Parquet" => {
if parquet.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"And" => {
if and.is_some() { return Err(DeError::DuplicateField); }
and = Some(d.content()?);
Ok(())
}
b"Prefix" => {
...
b"Tag" => {
if tag.is_some() { return Err(DeError::DuplicateField); }
tag = Some(d.content()?);
Ok(())
}
_ => Err(DeError::UnexpectedTagName)
...
d.for_each_element(|d, x| match x {
b"Destination" => {
if destination.is_some() { return Err(DeError::DuplicateField); }
...
if included_object_versions.is_some() { return Err(DeError::DuplicateField); }
included_object_versions = Some(d.content()?);
Ok(())
}
b"IsEnabled" => {
if is_enabled.is_some() { return Err(DeError::DuplicateField); }
is_enabled = Some(d.content()?);
Ok(())
}
b"OptionalFields" => {
if optional_fields.is_some() { return Err(DeError::DuplicateField); }
optional_fields = Some(d.list_content("Field")?);
Ok(())
}
b"Schedule" => {
if schedule.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"SSE-KMS" => {
if ssekms.is_some() { return Err(DeError::DuplicateField); }
ssekms = Some(d.content()?);
Ok(())
}
b"SSE-S3" => {
if sses3.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"AccountId" => {
if account_id.is_some() { return Err(DeError::DuplicateField); }
...
b"Encryption" => {
if encryption.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Frequency" => {
if frequency.is_some() { return Err(DeError::DuplicateField); }
...
b"CloudFunction" => {
if lambda_function_arn.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Date" => {
if date.is_some() { return Err(DeError::DuplicateField); }
...
if expired_object_all_versions.is_some() { return Err(DeError::DuplicateField); }
expired_object_all_versions = Some(d.content()?);
Ok(())
}
b"ExpiredObjectDeleteMarker" => {
if expired_object_delete_marker.is_some() { return Err(DeError::DuplicateField); }
...
if abort_incomplete_multipart_upload.is_some() { return Err(DeError::DuplicateField); }
abort_incomplete_multipart_upload = Some(d.content()?);
Ok(())
}
b"DelMarkerExpiration" => {
if del_marker_expiration.is_some() { return Err(DeError::DuplicateField); }
...
if noncurrent_version_expiration.is_some() { return Err(DeError::DuplicateField); }
...
if object_size_greater_than.is_some() { return Err(DeError::DuplicateField); }
object_size_greater_than = Some(d.content()?);
Ok(())
}
b"ObjectSizeLessThan" => {
if object_size_less_than.is_some() { return Err(DeError::DuplicateField); }
...
b"ContinuationToken" => {
if continuation_token.is_some() { return Err(DeError::DuplicateField); }
...
if next_continuation_token.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Buckets" => {
if buckets.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"TargetBucket" => {
if target_bucket.is_some() { return Err(DeError::DuplicateField); }
target_bucket = Some(d.content()?);
Ok(())
}
b"TargetGrants" => {
if target_grants.is_some() { return Err(DeError::DuplicateField); }
target_grants = Some(d.list_content("Grant")?);
Ok(())
}
b"TargetObjectKeyFormat" => {
if target_object_key_format.is_some() { return Err(DeError::DuplicateField); }
target_object_key_format = Some(d.content()?);
Ok(())
}
b"TargetPrefix" => {
if target_prefix.is_some() { return Err(DeError::DuplicateField); }
...
if s3_tables_destination.is_some() { return Err(DeError::DuplicateField); }
...
if s3_tables_destination_result.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"EventThreshold" => {
if event_threshold.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"AccessPointArn" => {
if access_point_arn.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"ChecksumAlgorithm" => {
if checksum_algorithm.is_some() { return Err(DeError::DuplicateField); }
...
b"Initiated" => {
if initiated.is_some() { return Err(DeError::DuplicateField); }
initiated = Some(d.timestamp(TimestampFormat::DateTime)?);
Ok(())
}
b"Initiator" => {
if initiator.is_some() { return Err(DeError::DuplicateField); }
...
b"UploadId" => {
if upload_id.is_some() { return Err(DeError::DuplicateField); }
...
if newer_noncurrent_versions.is_some() { return Err(DeError::DuplicateField); }
newer_noncurrent_versions = Some(d.content()?);
Ok(())
}
b"NoncurrentDays" => {
if noncurrent_days.is_some() { return Err(DeError::DuplicateField); }
...
b"RestoreStatus" => {
if restore_status.is_some() { return Err(DeError::DuplicateField); }
restore_status = Some(d.content()?);
Ok(())
}
b"Size" => {
if size.is_some() { return Err(DeError::DuplicateField); }
size = Some(d.content()?);
Ok(())
}
b"StorageClass" => {
...
b"LastModifiedTime" => {
if last_modified_time.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"ObjectLockEnabled" => {
if object_lock_enabled.is_some() { return Err(DeError::DuplicateField); }
object_lock_enabled = Some(d.content()?);
Ok(())
}
b"Rule" => {
if rule.is_some() { return Err(DeError::DuplicateField); }
rule = Some(d.content()?);
Ok(())
}
_ => Err(DeError::UnexpectedTagName)
...
b"RetainUntilDate" => {
if retain_until_date.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"DefaultRetention" => {
if default_retention.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"S3" => {
if s3.is_some() { return Err(DeError::DuplicateField); }
s3 = Some(d.content()?);
Ok(())
}
_ => Err(DeError::UnexpectedTagName)
...
d.for_each_element(|d, x| match x {
b"ObjectOwnership" => {
if object_ownership.is_some() { return Err(DeError::DuplicateField); }
...
if partition_date_source.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"IsPublic" => {
if is_public.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"BytesProcessed" => {
if bytes_processed.is_some() { return Err(DeError::DuplicateField); }
bytes_processed = Some(d.content()?);
Ok(())
}
b"BytesReturned" => {
if bytes_returned.is_some() { return Err(DeError::DuplicateField); }
bytes_returned = Some(d.content()?);
Ok(())
}
b"BytesScanned" => {
if bytes_scanned.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"BlockPublicAcls" => {
if block_public_acls.is_some() { return Err(DeError::DuplicateField); }
block_public_acls = Some(d.content()?);
Ok(())
}
b"BlockPublicPolicy" => {
if block_public_policy.is_some() { return Err(DeError::DuplicateField); }
block_public_policy = Some(d.content()?);
Ok(())
}
b"IgnorePublicAcls" => {
if ignore_public_acls.is_some() { return Err(DeError::DuplicateField); }
ignore_public_acls = Some(d.content()?);
Ok(())
}
b"RestrictPublicBuckets" => {
if restrict_public_buckets.is_some() { return Err(DeError::DuplicateField); }
...
b"Queue" => {
if queue_arn.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"HostName" => {
if host_name.is_some() { return Err(DeError::DuplicateField); }
host_name = Some(d.content()?);
Ok(())
}
b"HttpRedirectCode" => {
if http_redirect_code.is_some() { return Err(DeError::DuplicateField); }
http_redirect_code = Some(d.content()?);
Ok(())
}
b"Protocol" => {
if protocol.is_some() { return Err(DeError::DuplicateField); }
protocol = Some(d.content()?);
Ok(())
}
b"ReplaceKeyPrefixWith" => {
if replace_key_prefix_with.is_some() { return Err(DeError::DuplicateField); }
replace_key_prefix_with = Some(d.content()?);
Ok(())
}
b"ReplaceKeyWith" => {
if replace_key_with.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Role" => {
if role.is_some() { return Err(DeError::DuplicateField); }
role = Some(d.content()?);
Ok(())
}
b"Rule" => {
...
if delete_marker_replication.is_some() { return Err(DeError::DuplicateField); }
delete_marker_replication = Some(d.content()?);
Ok(())
}
b"DeleteReplication" => {
if delete_replication.is_some() { return Err(DeError::DuplicateField); }
...
if existing_object_replication.is_some() { return Err(DeError::DuplicateField); }
...
b"Priority" => {
if priority.is_some() { return Err(DeError::DuplicateField); }
priority = Some(d.content()?);
Ok(())
}
b"SourceSelectionCriteria" => {
if source_selection_criteria.is_some() { return Err(DeError::DuplicateField); }
...
b"Time" => {
if time.is_some() { return Err(DeError::DuplicateField); }
time = Some(d.content()?);
Ok(())
}
_ => Err(DeError::UnexpectedTagName)
...
d.for_each_element(|d, x| match x {
b"Minutes" => {
if minutes.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Enabled" => {
if enabled.is_some() { return Err(DeError::DuplicateField); }
...
b"Description" => {
if description.is_some() { return Err(DeError::DuplicateField); }
description = Some(d.content()?);
Ok(())
}
b"GlacierJobParameters" => {
if glacier_job_parameters.is_some() { return Err(DeError::DuplicateField); }
glacier_job_parameters = Some(d.content()?);
Ok(())
}
b"OutputLocation" => {
if output_location.is_some() { return Err(DeError::DuplicateField); }
output_location = Some(d.content()?);
Ok(())
}
b"SelectParameters" => {
if select_parameters.is_some() { return Err(DeError::DuplicateField); }
...
if is_restore_in_progress.is_some() { return Err(DeError::DuplicateField); }
is_restore_in_progress = Some(d.content()?);
Ok(())
}
b"RestoreExpiryDate" => {
if restore_expiry_date.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Condition" => {
if condition.is_some() { return Err(DeError::DuplicateField); }
condition = Some(d.content()?);
Ok(())
}
b"Redirect" => {
if redirect.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"AccessControlList" => {
if access_control_list.is_some() { return Err(DeError::DuplicateField); }
access_control_list = Some(d.list_content("Grant")?);
Ok(())
}
b"BucketName" => {
if bucket_name.is_some() { return Err(DeError::DuplicateField); }
bucket_name = Some(d.content()?);
Ok(())
}
b"CannedACL" => {
if canned_acl.is_some() { return Err(DeError::DuplicateField); }
...
b"Tagging" => {
if tagging.is_some() { return Err(DeError::DuplicateField); }
tagging = Some(d.content()?);
Ok(())
}
b"UserMetadata" => {
if user_metadata.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"TableBucketArn" => {
if table_bucket_arn.is_some() { return Err(DeError::DuplicateField); }
table_bucket_arn = Some(d.content()?);
Ok(())
}
b"TableName" => {
if table_name.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"TableArn" => {
if table_arn.is_some() { return Err(DeError::DuplicateField); }
...
b"TableNamespace" => {
if table_namespace.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"KeyId" => {
if key_id.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"End" => {
if end.is_some() { return Err(DeError::DuplicateField); }
end = Some(d.content()?);
Ok(())
}
b"Start" => {
if start.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"Expression" => {
if expression.is_some() { return Err(DeError::DuplicateField); }
expression = Some(d.content()?);
Ok(())
}
b"ExpressionType" => {
if expression_type.is_some() { return Err(DeError::DuplicateField); }
expression_type = Some(d.content()?);
Ok(())
}
b"InputSerialization" => {
if input_serialization.is_some() { return Err(DeError::DuplicateField); }
input_serialization = Some(d.content()?);
Ok(())
}
b"OutputSerialization" => {
if output_serialization.is_some() { return Err(DeError::DuplicateField); }
output_serialization = Some(d.content()?);
Ok(())
}
b"RequestProgress" => {
if request_progress.is_some() { return Err(DeError::DuplicateField); }
request_progress = Some(d.content()?);
Ok(())
}
b"ScanRange" => {
if scan_range.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"KMSMasterKeyID" => {
if kms_master_key_id.is_some() { return Err(DeError::DuplicateField); }
kms_master_key_id = Some(d.content()?);
Ok(())
}
b"SSEAlgorithm" => {
if sse_algorithm.is_some() { return Err(DeError::DuplicateField); }
...
if apply_server_side_encryption_by_default.is_some() { return Err(DeError::DuplicateField); }
apply_server_side_encryption_by_default = Some(d.content()?);
Ok(())
}
b"BucketKeyEnabled" => {
if bucket_key_enabled.is_some() { return Err(DeError::DuplicateField); }
...
if replica_modifications.is_some() { return Err(DeError::DuplicateField); }
replica_modifications = Some(d.content()?);
Ok(())
}
b"SseKmsEncryptedObjects" => {
if sse_kms_encrypted_objects.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"DataExport" => {
if data_export.is_some() { return Err(DeError::DuplicateField); }
...
if output_schema_version.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"PartitionedPrefix" => {
if partitioned_prefix.is_some() { return Err(DeError::DuplicateField); }
partitioned_prefix = Some(d.content()?);
Ok(())
}
b"SimplePrefix" => {
if simple_prefix.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"AccessTier" => {
if access_tier.is_some() { return Err(DeError::DuplicateField); }
...
b"Topic" => {
if topic_arn.is_some() { return Err(DeError::DuplicateField); }
...
d.for_each_element(|d, x| match x {
b"ExcludeFolders" => {
if exclude_folders.is_some() { return Err(DeError::DuplicateField); }
